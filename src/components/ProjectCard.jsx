...
const ProjectCard = ({ project, onExpand }) => (
  <div className="glass glow-border rounded-2xl p-6 sm:p-7 flex flex-col h-full min-w-[300px]">
    ...
    <p className="text-[color:var(--text-dim)] text-sm mb-5">{project.tagline}</p>
    ...
    <div className="mt-auto flex items-center gap-3">
      <button
        ...
        className="magnetic-btn flex-1 glass border border-white/15 font-mono text-xs font-semibold px-4 py-3 rounded-xl flex items-center justify-center gap-2"
      >
        <Icon name="layers" className="w-4 h-4" /> Architecture
      </button>
      <a
        href={project.github}
        target="_blank"
